...
* Group formed, project topic chosen, short project description written
* Project repository scaffolded (from a cookiecutter/MLOps template)
* Git workflow set up: branching strategy, write access for all team members
* CI pipeline running on push: at least linting + one test
...
See `../reference/sprint_a_project.md` for source material and drafting notes.
