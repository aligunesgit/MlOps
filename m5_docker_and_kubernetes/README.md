...
orchestrator instead — broader ecosystem, every major cloud offers a managed version (Module 7) — which
...
| **Service** | A stable network name/address that routes traffic to whichever Pods currently match it — Pods come and go, the Service address doesn't |
...
simplify packaging and scaling a served model on Kubernetes — worth knowing the name exists once you're
